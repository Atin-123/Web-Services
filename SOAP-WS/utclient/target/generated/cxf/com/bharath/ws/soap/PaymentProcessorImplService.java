 ...
 * 2023-04-27T11:37:37.047+05:30
 * Generated source version: 3.3.0
 *
 */
@WebServiceClient(name = "PaymentProcessorImplService",
                  wsdlLocation = "file:/E:/spring-suite-tool-workspace/utclient/src/main/resources/wsdl/paymentProcessor.wsdl",
...
public class PaymentProcessorImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/spring-suite-tool-workspace/utclient/src/main/resources/wsdl/paymentProcessor.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PaymentProcessorImplService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/E:/spring-suite-tool-workspace/utclient/src/main/resources/wsdl/paymentProcessor.wsdl");
        }
        WSDL_LOCATION = url;
    }

 ...
 * generated in the com.akp.ws.soap package. 
...
public class ObjectFactory {
    ...
    private final static QName _Download_QNAME = new QName("http://soap.ws.akp.com/", "download");
    private final static QName _DownloadResponse_QNAME = new QName("http://soap.ws.akp.com/", "downloadResponse");
    private final static QName _Upload_QNAME = new QName("http://soap.ws.akp.com/", "upload");
    private final static QName _UploadResponse_QNAME = new QName("http://soap.ws.akp.com/", "uploadResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.akp.ws.soap
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://soap.ws.akp.com/", name = "download")
     ...
     */
    @XmlElementDecl(namespace = "http://soap.ws.akp.com/", name = "downloadResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://soap.ws.akp.com/", name = "upload")
     ...
     */
    @XmlElementDecl(namespace = "http://soap.ws.akp.com/", name = "uploadResponse")
